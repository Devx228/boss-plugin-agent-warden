# Agent Warden: operator approval and evidence capture for agent MCP tool calls

Draft PR description. Not yet opened; see the checklist at the end.
...
- [ ] Decide the PR target: this repo's `main`, or a proposal against BossConsole
- [ ] Check whether `risa-labs-inc/BossConsole#332` has an answer that changes the
      transport
- [ ] Consider a short screen recording of the refusal, which is the demo
- [ ] Read every file in the diff. AI assistance is allowed; you remain responsible
      for what you submit, and you will be asked about it
